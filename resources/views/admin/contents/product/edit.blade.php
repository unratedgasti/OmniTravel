                                         ...
                                         <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                 @if($page_data['product']->prod_image)
                                                  <img style="border: 1px solid #ddd; border-radius: 4px; padding: 5px;width: 100px;" src="{{asset('includes/admin/products/'.$page_data['product']->prod_image)}}">
                                                 @else
                                          ...
                                          <fieldset>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                  <input type="file" name="prod_images">
                                                </div>
                                            </div>
                                        </fieldset>
                                          <fieldset>
